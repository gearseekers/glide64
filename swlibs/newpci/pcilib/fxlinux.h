...
void pci_close_linux(int fd);
int pci_read_config_long_linux(int fd, int bus, int dev, int fn, int addr, FxU32 *result);
int pci_write_config_long_linux(int fd, int bus, int dev, int fn, int addr, FxU32 data);
