...
//
void FX_CSTYLE
_FxI32ToI64(int64_t *dst, int32_t src)
{
    *dst = (int64_t)src;
}
...
//
void FX_CSTYLE
_FxI64ToI32(int32_t *dst, const int64_t *src)
{
    *dst = (int32_t)*src;
}
...
//
void FX_CSTYLE
_FxAddI64(int64_t *r, const int64_t *a, const int64_t *b)
{
    *r = *a + *b;
}
...
//
void FX_CSTYLE
_FxU32Mul(uint64_t *r, uint32_t a, uint32_t b)
{
