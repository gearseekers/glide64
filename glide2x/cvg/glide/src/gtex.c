          ...
          GrTextureFormat_t format, FxU32 evenOdd, void *data))
{
    ...
    FxU32 data_size = _grTexCalcMemRequired(thisLOD, aspectRatio, format);
    void* texture_memory = (void*)((FxU32)gc->tex_ptr + startAddress);

    // SSE2 Optimization for texture data transfer
